...
// for ES
DEF_REPORT_SEQUENCE_NAMED(ES_NTILDE, DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_SEMICOLON));
DEF_REPORT_SEQUENCE_NAMED(ES_NTILDE_SHIFT, DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_SEMICOLON));

// Acute accents (á, é, í, ó, ú)
DEF_REPORT_SEQUENCE_NAMED(ES_ACUTE_A, 
    DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_APOSTROPHE),
    DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_NONE),
    DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_A)
);
// Shifted acute accents (Á, É, Í, Ó, Ú)
DEF_REPORT_SEQUENCE_NAMED(ES_ACUTE_A_SHIFT, 
    DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_APOSTROPHE),
    DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_NONE),
    DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_A)
);

// AltGrrr combinations
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_1, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_1));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_2, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_2));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_3, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_3));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_9, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_9));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_0, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_0));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_MINUS, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_MINUS));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_COMMA, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_COMMA));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_COMMA_SHIFT, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT | HID_MOD_KEY_LEFT_SHIFT, HID_KEY_COMMA));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_E, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_E));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_DOT, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_DOT));
DEF_REPORT_SEQUENCE_NAMED(RALT_AND_DOT_SHIFT, DEF_REPORT(HID_MOD_KEY_RIGHT_ALT | HID_MOD_KEY_LEFT_SHIFT, HID_KEY_DOT));
...
#define LAYOUT_ES(PROC_FUNC) \
    ...
    PROC_FUNC(L'á', HID_REPORT_SEQUENCE_ES_ACUTE_A) \
    PROC_FUNC(L'é', HID_REPORT_SEQUENCE_ES_ACUTE_E) \
    PROC_FUNC(L'í', HID_REPORT_SEQUENCE_ES_ACUTE_I) \
    PROC_FUNC(L'ó', HID_REPORT_SEQUENCE_ES_ACUTE_O) \
    PROC_FUNC(L'ú', HID_REPORT_SEQUENCE_ES_ACUTE_U) \
    PROC_FUNC(L'Á', HID_REPORT_SEQUENCE_ES_ACUTE_A_SHIFT) \
    PROC_FUNC(L'É', HID_REPORT_SEQUENCE_ES_ACUTE_E_SHIFT) \
    PROC_FUNC(L'Í', HID_REPORT_SEQUENCE_ES_ACUTE_I_SHIFT) \
    PROC_FUNC(L'Ó', HID_REPORT_SEQUENCE_ES_ACUTE_O_SHIFT) \
    PROC_FUNC(L'Ú', HID_REPORT_SEQUENCE_ES_ACUTE_U_SHIFT) \
    PROC_FUNC(L'¡', HID_REPORT_SEQUENCE_RALT_AND_1) \
    PROC_FUNC(L'¿', HID_REPORT_SEQUENCE_RALT_AND_MINUS) \
    PROC_FUNC(L'@', HID_REPORT_SEQUENCE_RALT_AND_2) \
    PROC_FUNC(L'€', HID_REPORT_SEQUENCE_RALT_AND_E) \
    PROC_FUNC(L'ç', HID_REPORT_SEQUENCE_RALT_AND_COMMA) \
    PROC_FUNC(L'Ç', HID_REPORT_SEQUENCE_RALT_AND_COMMA_SHIFT) \
    PROC_FUNC(L'º', HID_REPORT_SEQUENCE_RALT_AND_0) \
    PROC_FUNC(L'ª', HID_REPORT_SEQUENCE_RALT_AND_9) \
    PROC_FUNC(L'\\', HID_REPORT_SEQUENCE_RALT_AND_DOT) \
    PROC_FUNC(L'|', HID_REPORT_SEQUENCE_RALT_AND_DOT_SHIFT) \
