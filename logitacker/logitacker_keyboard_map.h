...
// for ES
DEF_REPORT_SEQUENCE_NAMED(ES_NTILDE, 
  DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_SEMICOLON)
);
DEF_REPORT_SEQUENCE_NAMED(ES_NTILDE_SHIFT, 
  DEF_REPORT(HID_MOD_KEY_RIGHT_ALT | HID_MOD_KEY_LEFT_SHIFT, HID_KEY_SEMICOLON)
);
DEF_REPORT_SEQUENCE_NAMED(ES_INVERTED_QUESTION, 
  DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_MINUS)
);
