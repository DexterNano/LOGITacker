...
// ES-specific sequences (avoiding duplicates)
DEF_REPORT_SEQUENCE_NAMED(ES_RALT_2,          DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_2));
DEF_REPORT_SEQUENCE_NAMED(ES_RALT_3,          DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_3));
DEF_REPORT_SEQUENCE_NAMED(ES_RALT_9,          DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_9));
DEF_REPORT_SEQUENCE_NAMED(ES_RALT_0,          DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_0));
DEF_REPORT_SEQUENCE_NAMED(ES_RALT_E,          DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_E));
DEF_REPORT_SEQUENCE_NAMED(ES_RALT_MINUS,      DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_MINUS));
